...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tPrjectInfo
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tPrjectInfo");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tPrjectInfo(");
			strSql.Append("sGUID,sID,sName,sAuthor,fLng,fLat,dCreateDate,dUpdateTime,sRemark)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@sAuthor", SqlDbType.NVarChar,100),
			...
			parameters[3].Value = model.sAuthor;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tPrjectInfo set ");
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tPrjectInfo ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tPrjectInfo GetModel(string sGUID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sGUID,sID,sName,sAuthor,fLng,fLat,dCreateDate,dUpdateTime,sRemark from tPrjectInfo ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;

			LumluxSSYDB.Model.tPrjectInfo model=new LumluxSSYDB.Model.tPrjectInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tPrjectInfo DataRowToModel(DataRow row)
		{
			LumluxSSYDB.Model.tPrjectInfo model=new LumluxSSYDB.Model.tPrjectInfo();
			if (row != null)
			{
				...
				if(row["sAuthor"]!=null)
				{
					model.sAuthor=row["sAuthor"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,sID,sName,sAuthor,fLng,fLat,dCreateDate,dUpdateTime,sRemark ");
			strSql.Append(" FROM tPrjectInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tPrjectInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tPrjectInfo";
