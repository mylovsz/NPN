...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tCMDRevs
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tCMDRevs");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LumluxSSYDB.Model.tCMDRevs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tCMDRevs(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LumluxSSYDB.Model.tCMDRevs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tCMDRevs set ");
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tCMDRevs ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tCMDRevs GetModel(string sGUID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tCMDRevs DataRowToModel(DataRow row)
		{
			LumluxSSYDB.Model.tCMDRevs model=new LumluxSSYDB.Model.tCMDRevs();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tCMDRevs T ");
