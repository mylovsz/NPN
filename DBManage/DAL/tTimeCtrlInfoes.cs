...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tTimeCtrlInfoes
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tTimeCtrlInfoes");
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tTimeCtrlInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,iID,dTime,iEnable,iState_Command,dCreateDate,dUpdateTime,sHostInfoGUID,sTagGUID,sDesc ");
			strSql.Append(" FROM tTimeCtrlInfoes ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tTimeCtrlInfoes T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tTimeCtrlInfoes";
