...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tMeasurePowerInfoes
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tMeasurePowerInfoes");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tMeasurePowerInfoes(");
			strSql.Append("sGUID,iID,fValue,sMeasureInfoGUID,sDesc)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tMeasurePowerInfoes set ");
			...
			parameters[2].Value = model.sMeasureInfoGUID;
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tMeasurePowerInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tMeasurePowerInfoes DataRowToModel(DataRow row)
		{
			LumluxSSYDB.Model.tMeasurePowerInfoes model=new LumluxSSYDB.Model.tMeasurePowerInfoes();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,iID,fValue,sMeasureInfoGUID,sDesc ");
			strSql.Append(" FROM tMeasurePowerInfoes ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tMeasurePowerInfoes T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tMeasurePowerInfoes";
