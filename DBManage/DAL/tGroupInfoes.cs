...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tGroupInfoes
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tGroupInfoes");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LumluxSSYDB.Model.tGroupInfoes model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tGroupInfoes(");
			strSql.Append("sGUID,sProjectInfoGUID,sName,sID,dCreateDate,dUpdateTime,sRemark)");
			...
			parameters[1].Value = model.sProjectInfoGUID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LumluxSSYDB.Model.tGroupInfoes model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tGroupInfoes set ");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@sRemark", SqlDbType.NVarChar,500),
					new SqlParameter("@sGUID", SqlDbType.Char,36)};
			parameters[0].Value = model.sProjectInfoGUID;
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tGroupInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tGroupInfoes GetModel(string sGUID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sGUID,sProjectInfoGUID,sName,sID,dCreateDate,dUpdateTime,sRemark from tGroupInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;

			LumluxSSYDB.Model.tGroupInfoes model=new LumluxSSYDB.Model.tGroupInfoes();
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tGroupInfoes DataRowToModel(DataRow row)
		{
			LumluxSSYDB.Model.tGroupInfoes model=new LumluxSSYDB.Model.tGroupInfoes();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,sProjectInfoGUID,sName,sID,dCreateDate,dUpdateTime,sRemark ");
			strSql.Append(" FROM tGroupInfoes ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tGroupInfoes T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tGroupInfoes";
