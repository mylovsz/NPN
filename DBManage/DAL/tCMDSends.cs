...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tCMDSends
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tCMDSends");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tCMDSends(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tCMDSends set ");
			...
			strSql.Append("sHostIDID=@sHostIDID,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@sHostIDMAC", SqlDbType.NVarChar,100),
					new SqlParameter("@sGUID", SqlDbType.Char,36)};
			parameters[0].Value = model.iContentType;
			...
			parameters[5].Value = model.iHostIDType;
			parameters[6].Value = model.sHostIDAddr;
			parameters[7].Value = model.sHostIDID;
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tCMDSends ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tCMDSends GetModel(string sGUID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sGUID,iContentType,sContent,iState,dCreateDate,dUpdateTime,iHostIDType,sHostIDAddr,sHostIDID,sHostIDSIM,sHostIDIP,sHostIDMAC from tCMDSends ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tCMDSends T ");
