...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tJurisdiction
	{
		...
		public bool Exists(string sGUID)
		{
			...
			strSql.Append("select count(1) from tJurisdiction");
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tJurisdiction ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,sJurisdictionType,sJurisdictionContent,sPrjectGUID,sDesc,dCreateTime,dUpdateTime ");
			strSql.Append(" FROM tJurisdiction ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tJurisdiction T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tJurisdiction";
