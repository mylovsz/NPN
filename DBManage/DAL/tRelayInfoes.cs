...
namespace LumluxSSYDB.DAL
{
	...
	public partial class tRelayInfoes
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LumluxSSYDB.Model.tRelayInfoes model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tRelayInfoes(");
			strSql.Append("sGUID,iID,sName,sHostInfoGUID,dCreateDate,dUpdateTime,sRemark)");
			...
			parameters[3].Value = model.sHostInfoGUID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LumluxSSYDB.Model.tRelayInfoes model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tRelayInfoes set ");
		...
		public bool Delete(string sGUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tRelayInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tRelayInfoes GetModel(string sGUID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sGUID,iID,sName,sHostInfoGUID,dCreateDate,dUpdateTime,sRemark from tRelayInfoes ");
			strSql.Append(" where sGUID=@sGUID ");
			SqlParameter[] parameters = {
					new SqlParameter("@sGUID", SqlDbType.Char,36)			};
			parameters[0].Value = sGUID;

			LumluxSSYDB.Model.tRelayInfoes model=new LumluxSSYDB.Model.tRelayInfoes();
		...
		/// 得到一个对象实体
		/// </summary>
		public LumluxSSYDB.Model.tRelayInfoes DataRowToModel(DataRow row)
		{
			LumluxSSYDB.Model.tRelayInfoes model=new LumluxSSYDB.Model.tRelayInfoes();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sGUID,iID,sName,sHostInfoGUID,dCreateDate,dUpdateTime,sRemark ");
			strSql.Append(" FROM tRelayInfoes ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tRelayInfoes T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tRelayInfoes";
