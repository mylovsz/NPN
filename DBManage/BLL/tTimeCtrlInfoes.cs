...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tTimeCtrlInfoes dal=new LumluxSSYDB.DAL.tTimeCtrlInfoes();
		public tTimeCtrlInfoes()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tTimeCtrlInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tTimeCtrlInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tTimeCtrlInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tTimeCtrlInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tTimeCtrlInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tTimeCtrlInfoes> modelList = new List<LumluxSSYDB.Model.tTimeCtrlInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tTimeCtrlInfoes model;
