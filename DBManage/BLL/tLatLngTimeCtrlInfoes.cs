...
{
	/// <summary>
	/// tLatLngTimeCtrlInfoes
	/// </summary>
	public partial class tLatLngTimeCtrlInfoes
	{
		private readonly LumluxSSYDB.DAL.tLatLngTimeCtrlInfoes dal=new LumluxSSYDB.DAL.tLatLngTimeCtrlInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tLatLngTimeCtrlInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tLatLngTimeCtrlInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tLatLngTimeCtrlInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLatLngTimeCtrlInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLatLngTimeCtrlInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tLatLngTimeCtrlInfoes> modelList = new List<LumluxSSYDB.Model.tLatLngTimeCtrlInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tLatLngTimeCtrlInfoes model;
