...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tHostInfo dal=new LumluxSSYDB.DAL.tHostInfo();
		public tHostInfo()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tHostInfo GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tHostInfoModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tHostInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostInfo> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tHostInfo> modelList = new List<LumluxSSYDB.Model.tHostInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tHostInfo model;
