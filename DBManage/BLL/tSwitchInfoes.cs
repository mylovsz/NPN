...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tSwitchInfoes dal=new LumluxSSYDB.DAL.tSwitchInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tSwitchInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tSwitchInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tSwitchInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tSwitchInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tSwitchInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tSwitchInfoes> modelList = new List<LumluxSSYDB.Model.tSwitchInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tSwitchInfoes model;
