...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tPrjectSet dal=new LumluxSSYDB.DAL.tPrjectSet();
		public tPrjectSet()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tPrjectSet GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tPrjectSetModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tPrjectSet)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tPrjectSet> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tPrjectSet> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tPrjectSet> modelList = new List<LumluxSSYDB.Model.tPrjectSet>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tPrjectSet model;
