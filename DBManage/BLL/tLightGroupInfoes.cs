...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tLightGroupInfoes dal=new LumluxSSYDB.DAL.tLightGroupInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tLightGroupInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tLightGroupInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tLightGroupInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightGroupInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightGroupInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tLightGroupInfoes> modelList = new List<LumluxSSYDB.Model.tLightGroupInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tLightGroupInfoes model;
