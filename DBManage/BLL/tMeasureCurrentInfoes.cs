...
{
	/// <summary>
	/// tMeasureCurrentInfoes
	/// </summary>
	public partial class tMeasureCurrentInfoes
	{
		private readonly LumluxSSYDB.DAL.tMeasureCurrentInfoes dal=new LumluxSSYDB.DAL.tMeasureCurrentInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tMeasureCurrentInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tMeasureCurrentInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tMeasureCurrentInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureCurrentInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureCurrentInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tMeasureCurrentInfoes> modelList = new List<LumluxSSYDB.Model.tMeasureCurrentInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tMeasureCurrentInfoes model;
