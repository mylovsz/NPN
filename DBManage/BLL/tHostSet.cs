...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tHostSet dal=new LumluxSSYDB.DAL.tHostSet();
		public tHostSet()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tHostSet GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tHostSetModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tHostSet)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostSet> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostSet> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tHostSet> modelList = new List<LumluxSSYDB.Model.tHostSet>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tHostSet model;
