...
{
	/// <summary>
	/// tHolidayTimeCtrlInfoes
	/// </summary>
	public partial class tHolidayTimeCtrlInfoes
	{
		private readonly LumluxSSYDB.DAL.tHolidayTimeCtrlInfoes dal=new LumluxSSYDB.DAL.tHolidayTimeCtrlInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tHolidayTimeCtrlInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tHolidayTimeCtrlInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tHolidayTimeCtrlInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHolidayTimeCtrlInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHolidayTimeCtrlInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tHolidayTimeCtrlInfoes> modelList = new List<LumluxSSYDB.Model.tHolidayTimeCtrlInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tHolidayTimeCtrlInfoes model;
