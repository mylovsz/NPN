...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tHolidayInfoes dal=new LumluxSSYDB.DAL.tHolidayInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tHolidayInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tHolidayInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tHolidayInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHolidayInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHolidayInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tHolidayInfoes> modelList = new List<LumluxSSYDB.Model.tHolidayInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tHolidayInfoes model;
