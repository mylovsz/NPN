...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tMeasureConfigs dal=new LumluxSSYDB.DAL.tMeasureConfigs();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tMeasureConfigs GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tMeasureConfigsModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tMeasureConfigs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureConfigs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureConfigs> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tMeasureConfigs> modelList = new List<LumluxSSYDB.Model.tMeasureConfigs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tMeasureConfigs model;
