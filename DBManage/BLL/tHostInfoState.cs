...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tHostInfoState dal=new LumluxSSYDB.DAL.tHostInfoState();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tHostInfoState GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tHostInfoStateModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tHostInfoState)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostInfoState> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tHostInfoState> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tHostInfoState> modelList = new List<LumluxSSYDB.Model.tHostInfoState>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tHostInfoState model;
