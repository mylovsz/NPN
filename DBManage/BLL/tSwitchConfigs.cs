...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tSwitchConfigs dal=new LumluxSSYDB.DAL.tSwitchConfigs();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tSwitchConfigs GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tSwitchConfigsModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tSwitchConfigs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tSwitchConfigs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tSwitchConfigs> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tSwitchConfigs> modelList = new List<LumluxSSYDB.Model.tSwitchConfigs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tSwitchConfigs model;
