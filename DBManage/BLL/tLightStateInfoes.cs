...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tLightStateInfoes dal=new LumluxSSYDB.DAL.tLightStateInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tLightStateInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tLightStateInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tLightStateInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightStateInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightStateInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tLightStateInfoes> modelList = new List<LumluxSSYDB.Model.tLightStateInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tLightStateInfoes model;
