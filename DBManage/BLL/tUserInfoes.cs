...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tUserInfoes dal=new LumluxSSYDB.DAL.tUserInfoes();
		public tUserInfoes()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tUserInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tUserInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tUserInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tUserInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tUserInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tUserInfoes> modelList = new List<LumluxSSYDB.Model.tUserInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tUserInfoes model;
