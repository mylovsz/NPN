...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2016/12/6 8:18:55   N/A    初版
*
...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tBranchConfigs dal=new LumluxSSYDB.DAL.tBranchConfigs();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tBranchConfigs GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tBranchConfigsModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tBranchConfigs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tBranchConfigs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tBranchConfigs> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tBranchConfigs> modelList = new List<LumluxSSYDB.Model.tBranchConfigs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tBranchConfigs model;
