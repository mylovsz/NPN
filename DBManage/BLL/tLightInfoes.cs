...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tLightInfoes dal=new LumluxSSYDB.DAL.tLightInfoes();
		public tLightInfoes()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tLightInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tLightInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tLightInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tLightInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tLightInfoes> modelList = new List<LumluxSSYDB.Model.tLightInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tLightInfoes model;
