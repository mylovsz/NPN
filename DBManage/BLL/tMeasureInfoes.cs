...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tMeasureInfoes dal=new LumluxSSYDB.DAL.tMeasureInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tMeasureInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tMeasureInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tMeasureInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tMeasureInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tMeasureInfoes> modelList = new List<LumluxSSYDB.Model.tMeasureInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tMeasureInfoes model;
