...
namespace LumluxSSYDB.BLL
{
	...
	{
		private readonly LumluxSSYDB.DAL.tCtrlTagInfoes dal=new LumluxSSYDB.DAL.tCtrlTagInfoes();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LumluxSSYDB.Model.tCtrlTagInfoes GetModelByCache(string sGUID)
		{
			
			string CacheKey = "tCtrlTagInfoesModel-" + sGUID;
			...
			return (LumluxSSYDB.Model.tCtrlTagInfoes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tCtrlTagInfoes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LumluxSSYDB.Model.tCtrlTagInfoes> DataTableToList(DataTable dt)
		{
			List<LumluxSSYDB.Model.tCtrlTagInfoes> modelList = new List<LumluxSSYDB.Model.tCtrlTagInfoes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LumluxSSYDB.Model.tCtrlTagInfoes model;
